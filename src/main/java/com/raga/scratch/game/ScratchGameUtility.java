...
/**
 * 
 * This class provides utility methods for the scratch game application.
 * 
 * It includes methods to find applied winning combinations, calculate rewards
 * and find applied bonus symbols.
 */
